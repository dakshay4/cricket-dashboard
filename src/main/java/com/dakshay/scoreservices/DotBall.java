...
public class DotBall implements ScoreFactory{

    private final InningsStatistics inningsStatistics;


    public DotBall(InningsStatistics inningsStatistics) {
    ...
    public void update(int run) {
        ...
        playerStatistic.ifPresent(PlayerStatistics::incrementBallPlayed);
    }
}
